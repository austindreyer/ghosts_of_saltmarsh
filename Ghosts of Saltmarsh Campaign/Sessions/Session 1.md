...
2. The next morning, Domenico is on the docks and Alara's body washes up 
	1. Domenico tries CPR, pumps her chest, water came out of mouth but inconclusive to if it was from lungs or not (i.e. drowned)
	...
	8. Town council meeting:
		...
		4. Vinder is drumming up the troops 
			...
			2. Arvis wants money
			3. Portia wants to stop the house from being burned and learn what happened to Alara
			4. Domenico wants to know what happened, he can fight with his spells
		...
		6. Funeral 
			1. Kragg digs the grave, when he gets to the bottom, makes a comment about a worm sticking out of a rat at the bottom of the grave he just dug. He lights some kindling and sticks it on the rot grub and says, "you can't cut 'em, gotta burn 'em". He puts the body in, Burdok notices an old looking headstone with newly dug grave there
				...
				2. Kragg doesn't know, he starts digging up the freshly disturbed grave and finds the coffin has been broken apart, he checks the body, and where the organs should be, there are a bunch of smooth stones 
					...
					2. Kragg has never seen anything like this, the stone is a volcanic river stone, NOT from around here (from further north)
		...
		7. We head out at noon to the house, the town LOVES that we (i.e. expendables) are going to investigate, they follow us for 25 of the 30 min walk and then peace out when they get close
			...
			3. Rinn tries to open the door, opens to entrance hall with bare walls and smashed furniture with stairs going up, we go into first room on right and see there is nothing going on, but there is something in the fireplace that is shiny 
				1. Rinn goes and checks out the fireplace, we follow, there are two swarms of spiders there and they attack and we kill them
					1. Note, "swarms" of things should be fought with area of effect (AoE) attachs, NOT melee, if possible
				2. In the fireplace is a fine crystal bauble that looks like a counterweight to an achemist's set (5 sp) that Rinn takes
			4. Go to next door, hear the thumping, open the door, and Ned Shakeshaft is ties up in there and he is bound and gagged (like Alara)
				1. Q: what happened??
				2. A: found entrance to basement, heard a sound, like a glass heart shattering, it affected me, next thing i knew, i woke up here
				3. Q: who did you come here with?
				4. A: I came with the two, don't know where they are. Sorry to hear she did, i hooked up with them b/c they said there was treasure
				5. Q: Why do you do this?
				6. A: $
				7. Q: You didn't know them before?
				8. A: No
				9. (sidebar, he is telling the truth)
				10. Q: Where's your shit?
				11. A: Don't have it, don't know where it is
				12. (he comes with us)
			5. We go to the next door, Rinn opens the door, nothing going on
			6. Walk back down the hall, jump the gap, look in the next door and see a decayed master bedroom with shit scattered around with a wardrobe door closed that Rinn opens and nothing happening. 
			7. Next room, rubbish in guest room, nothing happening
			8. Next room, small room with busted up stuff in it, chest that is closed and locked. Open it up, robes that suck, documents that are decayed too much to read
			9. Last room upstairs, there is a storage room with a closed chest. Ned digs through the pile of closes there, he finds his stuff (leather armor, weapon)
			10. Rear stairwell doing down, another going up, both fucked, so Arvis misty steps up through hole in attic and drops a rope down and we (can) climb up. There are 6 sturges up there. Kill them and look through the sacks and find:
				1. A porcelin doll with jade eyes (20 gps)
			11. We go back to the ground floor, start exploring, find a loose brick above a fireplace in the first room, find a wooden box with 30 cp, 2 small pouches alchemical powders worth 10 gp 
			12. Dining room is next, just junk room
...
1. We collectively receive 650 XP
	1. 93/character (300 for level 2)
2. We collected items worth 30 gp, 5 sp, 30 cp
3. We have used one short rest
	1. Rinn and Arvis have used their hit die to recover health on first short rest
4. It's about 2:00 pm when we reach the basement 
