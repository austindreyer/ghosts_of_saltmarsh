...
2. Manistrad Copperlocks (dwarf) ^Copperlocks
	1. Appointed by king
	2. [[Saltmarsh Player's Guide#The Factions of Saltmarsh|Loyalist]]
...
2. Wicker Goat (Lankus Kurrid - Owner)
		1. Oldest in town
		2. Owned by a Keoish army 
		3. Loyalist bar
3. Empty Net (Kreb Shenker - owner)
		1. Smuggler/mercenary/pirate bar
		2. Traditionalists bar (hard side)
		3. Fighting bar, tough customers, town guard only comes if called
## Shopkeepers
...
4. Jilar Kanklesten (gnome)
	1. Carpenters' guildmaster
5. Pippin Fairbarn (dwarf)
	1. Cooper
6. Winston (hafling)
